...
event_listeners_1.expressEventEmitter.on(event_listeners_1.customExpressEvents.NEW_POST, function (newPost) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    newPost.date = null;
                    return [4 /*yield*/, messaging_1.postTopic.publishJSON(newPost)];
                case 1:
                    res = _a.sent();
                    console.log("Pub Sub message id: " + res);
                    loggers_1.logger.debug("Pub Sub message id: " + res);
                    return [3 /*break*/, 3];
                case 2:
                    e_1 = _a.sent();
